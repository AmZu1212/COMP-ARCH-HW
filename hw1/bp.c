...
#define TYPE_DBG 0				// toggle for bp type debug prints (1). leave on 0.
...
int BP_init(unsigned btbSize, unsigned historySize, unsigned tagSize, unsigned fsmState,
	...
	// this is mandatory becuase if u put 0 it 
	// clashes with commands with 0 tag. - bug fixed
	for(uint32_t i = 0; i < this_btbSize; i++){
		this_bp->BPtable[i][0] = MAX; // 11111111...
	}
